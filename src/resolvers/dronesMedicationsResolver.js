...
const dronesMedicationsResolver = {
    ...
    Mutation: {
        createDroneMedication: async (parent, { droneId, medicationId, batteryUse, deliveryStatus }) => {
            try {
                const newDroneMedication = await DronesMedicationsController.createDroneMedication({
                    droneId,
                    medicationId,
                    batteryUse,
                    deliveryStatus,
        ...
        updateDroneMedication: async (parent, { id, batteryUse, deliveryStatus }) => {
            try {
                const updatedDroneMedication = await DronesMedicationsController.updateDroneMedication({
                    id,
                    batteryUse,
                    deliveryStatus,
                });
